 ...
 * Contiene la inspección visual interna del chasis del vehículo
 */
...
if (!isset($chasis)) {
    throw new Exception("Variable \$chasis no está disponible en la sección inspección visual interna");
}
    ...
    <div class="inspeccion-contenido">
        ...
        <div class="inspeccion-detalle">
            ...
            <div class="observaciones">
                OBSERVACIONES: <br/> 
                <?php echo htmlspecialchars($peritaje["observaciones_inspeccion_interna"] ?? ''); ?>
            </div>
        </div>
    </div>
</section>

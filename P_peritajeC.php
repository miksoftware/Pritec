...
<main class="w-100">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="d-flex flex-column w-100">
                            ...
                            <div class="d-flex gap-2 w-100" style="height: 200px">
                                <img
                                        src="<?php echo $tiposVehiculos[$peritaje["tipo_vehiculo"]]->urlCarroceria; ?>"
                                        class="w-50"
                                            ...
                                            <div class="d-flex gap-2">
                                                <div class="yellow-background label" style="width: 70%">
                                                    <?php echo htmlspecialchars(
                                                        $fila["descripcion_pieza"]
                                                    ); ?>
                                                </div>
                                                <div class="input"><?php echo htmlspecialchars(
                                                        $fila["concepto"]
                                                    ); ?></div>
                                            </div>
                                        <?php endforeach; ?>
                            ...
                            <div class="remarks">
                                OBSERVACIONES: <br/> <?php echo htmlspecialchars(
                                    $peritaje["observaciones_inspeccion"]
                                ); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="d-flex flex-column w-100">
                            ...
                            <div>
                                ...
                                <div class="d-flex gap-2 w-100">
                                    <img src="<?php echo $tiposVehiculos[$peritaje["tipo_vehiculo"]]->urlChasis; ?>"
                                         class="w-50"
                                         class="w-50" style="object-fit: contain; max-height: 200px">
                                    <div class="d-flex flex-column gap-2 w-50 h-100">
                                        <div class="d-flex gap-2">
                        ...
                        <div class="mx-auto d-flex flex-column gap-2" style="width: 95%; font-size: 0.9rem">
                            ...
                            <div class="d-flex justify-content-center gap-1">
                                <p class="text-align-right">
                                    0-24% Peligroso: Cambia tu llanta
                                    <div style="width: 20px; height: 15px; background-color:#ff3933;"></div>
                                </p>
                                <p class="text-align-left">
                                <div style="width: 20px; height: 15px; background-color:#ffff33;"></div>
                                    50-74% Seguro: Desgaste leve
                                </p>
                            </div>
                            <div class="d-flex justify-content-center gap-1">
                                <p class="text-align-right">
                                    25-49% Precaución: Considera cambiar tu llanta pronto
                                <div style="width: 20px; height: 15px; background-color:#ff8a33;"></div>
                                </p>
                                <p class="text-align-left">
                                <div style="width: 20px; height: 15px; background-color:#36d048;"></div>
                                75-100% Nuevas: No necesita reemplazo
                                </p>
                            </div>
                        </div>
                        <div>
                            <div class="yellow-background sub-title ms-4 mb-0">LLANTAS</div>
                            <div class="d-flex gap-2 w-100">
                                <?php if (
                                    str_contains(
                                        $peritaje["tipo_vehiculo"],
                                    ...
                                    <img src="img/LLANTAS%20MOTO.png" class="w-50" style="object-fit: contain; max-height: 200px">
                                <?php else: ?>
                                    <img src="img/llantas.png" class="w-50" style="object-fit: contain; max-height: 200px">
                                <?php endif; ?>
                                <div class="d-flex flex-column gap-2 w-50 h-100">
                                    <div class="d-flex gap-2">
                                        <div class="yellow-background label text-center" style="width: fit-content">
                                            ITEM
                                        </div>
                                        <div class="yellow-background label text-center" style="width: fit-content">
                                            CONCEPTO
                    ...
                    <div class="d-flex gap-2 w-100">
                        ...
                        <div class="d-flex flex-column gap-2 h-100" style="width: 70%;">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <div class="input text-center">
                                    <?php echo getStateByPercent(
                                        $peritaje["prueba_bateria"]
                                    ); ?>
                                </div>
                                <div class="input text-center">
    ...
    <section class="rounded simple-border">
        <div class="d-flex gap-2">

...
CREATE TABLE IF NOT EXISTS `peritaje_completo` (
  ...
  `estado_cauchos_suspension` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_tanque_catalizador_gases` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_tubo_exhosto` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_radiador` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_externo_bateria` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_cables_instalacion_alta` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_tanque_silenciador` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_filtro_aire` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_brazos_direccion_rotulas` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fugas_tanque_combustible` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fugas_aceite_amortiguadores` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fugas_liquido_bomba_embrague` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fuga_aceite_direccion_hidraulica` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fuga_liquido_frenos` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fuga_aceite_caja_transmision` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fuga_aceite_caja_velocidades` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tension_correas` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_correas` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_mangueras_radiador` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_tuberias_frenos` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_guardapolvo_caja_direccion` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_protectores_inferiores` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_carter` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fuga_aceite_motor` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_guardapolvos_ejes` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_tijeras` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_radiador_aa` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_soporte_motor` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado_carcasa_caja_velocidades` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `viscosidad_aceite_motor` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nivel_refrigerante_motor` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nivel_liquido_frenos` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nivel_agua_limpiavidrios` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nivel_aceite_direccion_hidraulica` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nivel_liquido_embrague` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nivel_aceite_motor` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `funcionamiento_aa` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `soporte_caja_velocidades` enum('bueno','malo','regular') COLLATE utf8mb4_unicode_ci DEFAULT NULL

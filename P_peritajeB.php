...
<main class="w-100">
    ...
    <section class="mx-4 d-flex flex-column gap-2">
        ...
        <div class="remarks" style="height: 120px;">
            <!-- <img height="100" style="object-fit: contain;" src="<?php echo $peritaje['licencia_frente'] ?>" />
            <img height="100" style="object-fit: contain;" src="<?php echo $peritaje['licencia_atras'] ?>" /> -->
        </div>
    </section>
    <section class="mx-2">

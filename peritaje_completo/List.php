...
/**
 * Obtiene el listado de peritajes completos ordenados por fecha de creación descendente
 * 
...
function listarPeritajes($busqueda = '', $campo = 'id', $orden = 'DESC') {
    try {
        ...
        $camposValidos = ['id', 'nombre_apellidos', 'identificacion', 'placa', 'fecha', 'fecha_creacion', 'marca', 'tipo_vehiculo'];
        ...
        while ($row = $resultado->fetch_assoc()) {
            // Agregar formato al tipo de vehículo
            $tipoVehiculo = explode(' - ', $row['tipo_vehiculo'])[0] ?? $row['tipo_vehiculo'];
        ...
        error_log("Error en listar peritajes: " . $e->getMessage());

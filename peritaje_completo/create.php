...
try {
    ...
    $columnas = [
        ...
        'fijacion_fotografica_1',
        'fijacion_fotografica_2',
        'fijacion_fotografica_3',
        'fijacion_fotografica_4',
        'fijacion_fotografica_5',
        'fijacion_fotografica_6',
        'observaciones',
        'observaciones2',
        ...
        'estado_aire_acondicionado',
        'respuesta_aire_acondicionado',
        'estado_cinturones',
        'respuesta_cinturones',
        'estado_tapiceria_asientos',
    ...
    header('Location: ../c_peritajeC.php?saved=true'); // Redirige de vuelta con parámetro saved
    exit;
} catch (Exception $e) {
